...
//        enemyHealth = GetComponent<EnemyHealth>();
        ...
        //is inside the enemy bones, not at the "general" enemy
    ...
    void Update() {
        ...
        //**player doesn't have collider, if she has, this doesn't work
        //**check the radius of the characters if it doesn't work correctly
     ...
     //    Debug.Log(playerInRange); //show in console true or false if you're inside the range or not
